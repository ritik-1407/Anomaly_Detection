...
def load_data() -> np.ndarray:
        ...
        normalized_x_values = (data - data.mean()) / data.std()
        print("in load")
        print(normalized_x_values)
...
def plot_anomalies(data, scores, threshold):
    ...
    #update the CSV file 
    file_path='/Workspace/Shared/Plot/Cylinder-Bell-Funnel'
...
if __name__ == "__main__":
    ...
    json_string = '{"executionType": "execute", "dataInput": "", "dataOutput": "/Workspace/Shared/KNN files/output_scores_synthetic_datasets.csv", "customParameters": {"n_neighbors": 5 , "method": "largest", "radius": 1.0, "leaf_size": 30, "n_jobs": -1, "algorithm": "auto", "distance_metric": "minkowski", "distance_metric_order": 2}, "executionType": "execute"}'
